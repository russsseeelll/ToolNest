...
@section('content')
    <main class="container mx-auto py-12 px-6 flex justify-center">
        <div class="w-full max-w-md bg-white shadow-lg rounded-lg p-6">
            <h2 class="text-2xl font-bold text-[#003865] mb-6 text-center">Forgot Password</h2>
            ...
            <form action="{{ route('forgot.password') }}" method="POST">
                ...
                <div class="flex justify-center">
                    <button type="submit" class="bg-[#003865] text-white px-6 py-2 rounded-lg hover:bg-[#002a52]">Send Reset Link</button>
                </div>
                <div class="text-center mt-4">
                    <a href="{{ route('login') }}" class="text-[#003865] hover:underline">Back to Login</a>
                </div>
            </form>
        </div>
    </main>
